...
I intend to use Personomic to research my chronic illness and dysautonomia to an unprecedented level of detail, including a particularly unusual and experimentally manipulatable case of right-sided C-tactile allodynia.  Astonishingly, I can temporarily and reproducibly abolish the allodynia through vestibular, gustatory, auditory, and visceral interventions. These 5 distinct sensory modalities only converge in the insular cortex and for the right-sided body, predominantly in its left side. 

I'm thus creating an N-of-1 experimental protocol to measure event-related potentials (ERPs) from EEG during left-sided and right-sided brushing that stimulates C-tactile fibers, then using source localization with particular focus on the mid/posterior insula to see whether I can detect a consistent response pattern by intervention. Perhaps, I'll even be able to obtain evidence for functional localization in the insula that is rarely testable in humans.
